...
class ViewController: UIViewController, UIPickerViewDelegate, UIPickerViewDataSource {
    ...
    var directions = [CATransitionSubtype.fromLeft, CATransitionSubtype.fromRight, CATransitionSubtype.fromTop, CATransitionSubtype.fromBottom];
    ...
    func pickerView(_ pickerView: UIPickerView, titleForRow row: Int, forComponent component: Int) -> String? {
        ...
        switch(component){
            case 0:return transitions[row].lowercased()
            case 1: return directions[row].rawValue
