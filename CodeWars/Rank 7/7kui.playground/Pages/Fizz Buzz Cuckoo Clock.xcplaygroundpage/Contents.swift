...
func fizzBuzzCuckooClock(_ time: String) -> String {
    ...
    guard minutes != 30 else { return "Cuckoo" }
    guard minutes != 0 else {
        var hours = components.hour ?? 0
        if hours == 0 { hours = 12 }
        hours = hours > 12 ? hours - 12 : hours
        var repeated = String(repeating:"Cuckoo ", count: hours)
        return String(repeated.dropLast())
    }

    let threeDivision = minutes % 3
    let fiveDivision = minutes % 5

    if threeDivision == 0 && fiveDivision == 0 { return "Fizz Buzz" }
    else if threeDivision == 0  { return "Fizz" }
    else if fiveDivision == 0 { return "Buzz" }

    return "tick"
}


print(fizzBuzzCuckooClock("12:30"))
print(fizzBuzzCuckooClock("21:00"))
print(fizzBuzzCuckooClock("11:15"))
print(fizzBuzzCuckooClock("03:03"))
print(fizzBuzzCuckooClock("08:55"))
